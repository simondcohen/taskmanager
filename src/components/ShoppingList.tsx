...
export function ShoppingList({ items, onUpdateItems }: ShoppingListProps) {
  ...
  function shouldHideCompletedItem(item: ShoppingItem): boolean {
  ...
  // Function to mark an item as completed/uncompleted with timestamp
  ...
  return (
    <section className="bg-white rounded-lg shadow p-6">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-xl font-semibold text-indigo-700">Shopping List</h2>
        <button
